        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaStatusId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Areas_AreaStatuses_AreaStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Username = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, collation: "Latin1_General_CS_AS"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Areas_AreaStatusId",
                table: "Areas",
                column: "AreaStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Logins_UserId_Date_Id",
                table: "Logins",
                columns: new[] { "UserId", "Date", "Id" })
                .Annotation("SqlServer:Include", new[] { "MovementType" });
